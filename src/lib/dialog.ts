...
.dv-card{position:relative;max-width:420px;width:100%;padding:1.8rem 1.9rem 1.5rem;border-radius:20px;
...
.dv-btn-primary{background:currentColor;filter:invert(1) hue-rotate(180deg)}
/* skin surfaces */
